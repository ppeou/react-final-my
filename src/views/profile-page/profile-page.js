...
const ProfilePage = () => {
  ...
  return (<div key="profile-page" id="profile-page">
    {<Form {...formOptions}>
      {(props) => {
        return (
          <section className="profile-page-layout">
            ...
            <aside className="side">
              ...
              {/*<AsideMenu metaData={asideLayout.metaData} items={asideLayout.items}/>*/}
              {
                /*ComponentRender(asideLayout, 'profile-page-aside')*/
              }
            </aside>
            <section className="main">
              {/*<MemoLayoutRender layout={asideLayout} index="profile-page-detail"/>*/}
